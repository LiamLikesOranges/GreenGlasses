...
MODEL_NAME = "OrangeGlasses"

# ---- model architecture ----
# Small enough to train on a CPU in minutes. Bump these up if you have a GPU.
N_EMBED = 560        # embedding dimension (width of the model)
...
EVAL_ITERS = 30             # batches to average when estimating loss
GRAD_CLIP = 1.0
SEED = 18

# ---- sampling / generation ----
DEFAULT_MAX_NEW_TOKENS = 300
DEFAULT_TEMPERATURE = 0.3   # higher = more random/creative, lower = more predictable
